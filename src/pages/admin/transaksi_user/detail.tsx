...
function TransaksiUserDetail(props: snackbarProps) {
    const { id } = useParams()
            ...
            <Grid2 container rowSpacing={1} columnSpacing={{ xs: 1 }} marginTop={3}>
                <Grid2 className="bg-base-white rounded-lg" xs={12}>
                    <Stack spacing={3} padding={2}>
                        ...
                        <Grid2 container>
                            <Typography width={'250px'}>Offiline</Typography>
                        </Grid2>
                        <Grid2 container>
                            <Typography>Tes psikotes yang dilakukan secara langsung di lokasi biro psikologi, dengan pengawasan langsung dari psikolog atau asisten psikolog.</Typography>
                        </Grid2>
                        <Grid2 container>
...
export default TransaksiUserDetail 