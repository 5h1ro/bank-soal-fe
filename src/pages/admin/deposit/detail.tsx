...
function DepositDetail(props: snackbarProps) {
    const { id } = useParams()
    ...
    return (
        <Layout>
            ...
            <Grid2 container alignContent={'center'} className="w-full justify-between">
                <Grid2 container>
                    <IconButton onClick={() => navigate('/deposit')}>
                ...
                <Grid2 className="bg-base-white rounded-lg" xs={12}>
                    <Stack spacing={3} padding={2}>
                        <Grid2 container>
                            ...
                            <Typography className="w-full md:w-auto">Top Up</Typography>
                        </Grid2>
                        <Grid2 container>
                        ...
                        <Grid2 container>
                            <Typography width={'250px'}>Nominal</Typography>
                            <Typography className="w-full md:w-auto">{Currency({ value: 100000 })}</Typography>
                        </Grid2>
                        <Divider></Divider>
                        <Grid2 container>
                            <Typography width={'250px'}>Metode Transaksi</Typography>
                            <Typography className="w-full md:w-auto">BCA (1234567890)</Typography>
                        </Grid2>
                        <Grid2 container>
                            <Typography width={'250px'}>Invoice Transaksi</Typography>
                            <Typography className="w-full md:w-auto text-primary-500 cursor-pointer">https://paper.id/invoice/12782</Typography>
                        </Grid2>
                    </Stack>
                </Grid2>
            </Grid2>
