...
function RiwayatTes(props: snackbarProps) {
        ...
        },
        {
            ...
            Cell: ({ row }) => {
                return <div className='flex gap-2'>
                    <IconButton className="border-solid border-2 text-primary-500" aria-label="confirm" onClick={() => navigate(`/riwayat/${row.original.id}`)}>
                        <RiEyeLine />
                    </IconButton>
                </div>
            },
