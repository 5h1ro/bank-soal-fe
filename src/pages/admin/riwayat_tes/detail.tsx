import { Alert, Box, Button, Chip, Divider, IconButton, Snackbar, Stack, Step, StepLabel, Stepper, TextField, Typography } from "@mui/material";
...
function RiwayatDetailPeserta(props: snackbarProps) {
    const { id } = useParams()
    ...
    return (
        <Layout>
            ...
            <Grid2 container alignContent={'center'}>
                <IconButton onClick={() => navigate('/riwayat-tes')}>
                ...
                <Grid2 className="bg-base-white rounded-lg" xs={12}>
                    <Stack spacing={3} padding={2}>
                        ...
                        <Grid2 container gap={2}>
                            <Button className='w-48 px-6 py-4 rounded-xl bg-primary-500 text-base-white hover:bg-primary-500 hover:text-base-white' >
                                Download Hasil Tes
                            </Button>
                            <Button className='w-48 px-6 py-4 rounded-xl bg-base-white text-primary-500 hover:bg-base-white hover:text-primary-500' >
                                Kirim Hasil Tes
                            </Button>
                        </Grid2>
                    </Stack>
...
export default RiwayatDetailPeserta 