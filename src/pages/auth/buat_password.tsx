...
import { useCreatePasswordMutation } from '../../api/auth.api';
                    ...
                    <Grid container marginX={'auto'} marginY={'auto'}>
                        <Card sx={{ width: '750px', minHeight: '80.665vh', boxShadow: 'none' }} className='flex items-center justify-center'>
                            <CardContent className='w-[78.668%]'>
                                ...
                                <Grid marginTop={'24px'}>
                                    {!isLoading && (
                                        <Button type="submit" onClick={onCreate} className='text-lg text-base-white bg-primary-500 hover:bg-primary-500 font-medium rounded-xl p-4 w-full shadow-none hover:shadow-none' variant="contained">
                                            Buat Password
                                        </Button>
                                    )}
                                    {isLoading && (
